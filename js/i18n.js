...
const I18N = (() => {
  const dict = {
    ja: {
      ...
      secInterp: '★ フレーム補間でFPS向上',
      interpHint: '計算済みの光学フローを使い、実フレームの間に中間フレームを合成してなめらかさ(FPS)を引き上げます。',
      targetFps: '目標FPS',
      interpSmooth: 'スムーズ再生プレビュー(リアルタイム)',
      interpSmoothHint: '画面の更新頻度はディスプレイのリフレッシュレートまでが実質的な上限です。',
      interpExport: 'スーパースローモーション書き出し（WebM）',
      interpExportHint: '動画全体を目標FPS相当のコマ密度で合成し、なめらかなスローモーション動画として書き出します。長い動画・高い目標FPSほど時間がかかります。',
      secExport: '7. エクスポート',
      ...
      statFps: '処理速度', statRenderFps: '表示fps', statAvg: '平均速さ', statPeak: '最大速さ', statRes: '出力解像度', statResCompute: '計算',
      toastInterpDone: '高FPS書き出しが完了しました', framesWord: 'フレーム',
    ...
    en: {
      ...
      secInterp: '★ Raise FPS via frame interpolation',
      interpHint: 'Uses the already-computed optical flow to synthesize in-between frames, raising the effective smoothness (FPS).',
      targetFps: 'Target FPS',
      interpSmooth: 'Smooth playback preview (live)',
      interpSmoothHint: "The on-screen update rate is effectively capped by your display's refresh rate.",
      interpExport: 'Export super slow-motion (WebM)',
      interpExportHint: 'Synthesizes the whole video at a frame density matching the target FPS and exports it as a smooth slow-motion video. Longer clips and higher target FPS take more time.',
      secExport: '7. Export',
      ...
      statFps: 'Throughput', statRenderFps: 'Display fps', statAvg: 'Avg speed', statPeak: 'Peak speed', statRes: 'Output resolution', statResCompute: 'compute',
      toastInterpDone: 'High-FPS export complete', framesWord: 'frames',
