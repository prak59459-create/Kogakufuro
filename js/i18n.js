...
const I18N = (() => {
  const dict = {
    ja: {
      ...
      procScale: '処理解像度スケール', procScaleHint: '下げるほど高速化（1000fps級のステップ解析にはスケールを下げるのがおすすめ）',
      secAlgo: '4. アルゴリズム（Pyramidal Horn–Schunck）',
      preset: 'プリセット',
      presetBalanced: 'バランス', presetFast: '高速', presetPrecise: '高精度',
      ...
      statFps: '処理速度', statAvg: '平均速さ', statPeak: '最大速さ', statRes: '処理解像度',
    ...
    en: {
      ...
      procScale: 'Processing resolution scale', procScaleHint: 'Lower = faster (recommended for 1000fps-class step analysis)',
      secAlgo: '4. Algorithm (Pyramidal Horn–Schunck)',
      preset: 'Preset',
      presetBalanced: 'Balanced', presetFast: 'Fast', presetPrecise: 'High precision',
      ...
      statFps: 'Throughput', statAvg: 'Avg speed', statPeak: 'Peak speed', statRes: 'Proc. resolution',
